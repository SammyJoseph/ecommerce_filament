    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->plugin(
                \Filament\SpatieLaravelTranslatablePlugin::make()
                    ->defaultLocales((function() {
                        try {
                            if (class_exists(\App\Models\Language::class) && \Illuminate\Support\Facades\Schema::hasTable('languages')) {
                                $locales = \App\Models\Language::where('is_active', true)->pluck('code')->toArray();
                                return !empty($locales) ? $locales : ['es'];
                            }
                        } catch (\Throwable $e) {}
                        return ['es'];
                    })())
            ...
            ->pages([
                ...
                \App\Filament\Pages\SalesReports::class,
            ])
