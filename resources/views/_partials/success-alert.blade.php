...
<div x-data="{ show: true }" x-show="show" 
     ...
     id="alert-border-3" class="tw-fixed tw-bottom-0 tw-left-1/2 -tw-translate-x-1/2 tw-w-full tw-max-w-2xl tw-z-20 tw-flex tw-items-center tw-p-4 tw-text-green-800 tw-border-solid tw-border-0 tw-border-t-4 tw-border-green-300 tw-bg-green-50 dark:tw-text-green-400 dark:tw-bg-gray-800 dark:tw-border-green-800" role="alert">
    ...
    <button type="button" @click="show = false" class="tw-border-none tw-ms-auto tw--mx-1.5 tw--my-1.5 tw-bg-green-50 tw-text-green-500 tw-rounded-lg focus:tw-ring-2 focus:tw-ring-green-400 tw-p-1.5 hover:tw-bg-green-200 tw-inline-flex tw-items-center tw-justify-center tw-h-8 tw-w-8 dark:tw-bg-gray-800 dark:tw-text-green-400 dark:hover:tw-bg-gray-700" aria-label="Close">
