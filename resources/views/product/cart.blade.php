                    ...
                    <div class="header-bottom">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.html"><img src="{{ asset('assets2/images/logo/logo.png') }}" alt="logo"></a>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-7">
                                                ...
                                                <ul class="mega-menu-style mega-menu-mrg-1">
                                                    <li>
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="shop.html"><img src="{{ asset('assets2/images/banner/banner-12.png') }}" alt=""></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-5">
                            <div class="mobile-logo">
                                <a href="index.html">
                                    <img alt="" src="{{ asset('assets2/images/logo/logo.png') }}">
                                </a>
                            </div>
                        </div>
                        <div class="col-7">
                ...
                <div class="cart-content">
                    ...
                    <ul>
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="#"><img src="{{ asset('assets2/images/cart/cart-1.jpg') }}" alt=""></a>
                            </div>
                        ...
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="#"><img src="{{ asset('assets2/images/cart/cart-2.jpg') }}" alt=""></a>
                            </div>
                            <div class="cart-title">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="contact-info-wrap">
                            <div class="footer-logo">
                                <a href="#"><img src="{{ asset('assets2/images/logo/logo.png') }}" alt="logo"></a>
                            </div>
