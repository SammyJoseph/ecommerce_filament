                ...
                <div class="col">
                    <div class="product__details--media">
                        <div class="product__media--preview swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-a10de12238e1ba82f" aria-live="polite" style="transform: translate3d(-410px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="5" style="width: 400px; margin-right: 10px;" role="group" aria-label="6 / 6">
                                ...
                                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" style="width: 400px; margin-right: 10px;" role="group" aria-label="1 / 6">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product1.webp"><img class="product__media--preview__items--img" src="{{ $product ? $product->getFirstMediaUrl("product_images", "preview") : 'assets/img/product/big-product1.webp' }}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" style="width: 400px; margin-right: 10px;" role="group" aria-label="2 / 6">
                                    <div class="product__media--preview__items">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="2" style="width: 400px; margin-right: 10px;" role="group" aria-label="3 / 6">
                                    <div class="product__media--preview__items">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="3" style="width: 400px; margin-right: 10px;" role="group" aria-label="4 / 6">
                                    <div class="product__media--preview__items">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="4" style="width: 400px; margin-right: 10px;" role="group" aria-label="5 / 6">
                                    <div class="product__media--preview__items">
                                ...
                                <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="5" style="width: 400px; margin-right: 10px;" role="group" aria-label="6 / 6">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product6.webp"><img class="product__media--preview__items--img" src="assets/img/product/big-product6.webp" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="assets/img/product/big-product6.webp" data-gallery="product-media-preview">
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 400px; margin-right: 10px;" role="group" aria-label="1 / 6">
                                    <div class="product__media--preview__items">
                        ...
                        <div class="product__media--nav swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-free-mode swiper-thumbs">
                            <div class="swiper-wrapper" id="swiper-wrapper-6e9aaaa5b6d72c75" aria-live="polite" style="transform: translate3d(-410px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" style="width: 72px; margin-right: 10px;" role="group" aria-label="2 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product2.webp" alt="product-nav-img">
                                    </div>
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" style="width: 72px; margin-right: 10px;" role="group" aria-label="3 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product3.webp" alt="product-nav-img">
                                    </div>
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" style="width: 72px; margin-right: 10px;" role="group" aria-label="4 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product4.webp" alt="product-nav-img">
                                    </div>
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" style="width: 72px; margin-right: 10px;" role="group" aria-label="5 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product5.webp" alt="product-nav-img">
                                    </div>
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="5" style="width: 72px; margin-right: 10px;" role="group" aria-label="6 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product6.webp" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-thumb-active swiper-slide-visible swiper-slide-active" data-swiper-slide-index="0" style="width: 72px; margin-right: 10px;" role="group" aria-label="1 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product1.webp" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-visible swiper-slide-next" data-swiper-slide-index="1" style="width: 72px; margin-right: 10px;" role="group" aria-label="2 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product2.webp" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-visible" data-swiper-slide-index="2" style="width: 72px; margin-right: 10px;" role="group" aria-label="3 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product3.webp" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-visible" data-swiper-slide-index="3" style="width: 72px; margin-right: 10px;" role="group" aria-label="4 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product4.webp" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-visible" data-swiper-slide-index="4" style="width: 72px; margin-right: 10px;" role="group" aria-label="5 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product5.webp" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="5" style="width: 72px; margin-right: 10px;" role="group" aria-label="6 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product6.webp" alt="product-nav-img">
                                    </div>
                                </div>
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-thumb-active swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 72px; margin-right: 10px;" role="group" aria-label="1 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product1.webp" alt="product-nav-img">
                                    </div>
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" style="width: 72px; margin-right: 10px;" role="group" aria-label="2 / 6">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="assets/img/product/small-product2.webp" alt="product-nav-img">
                                    </div>
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" style="width: 72px; margin-right: 10px;" role="group" aria-label="3 / 6">
                            ...
                            <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-6e9aaaa5b6d72c75"></div>
                            <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-6e9aaaa5b6d72c75"></div>
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                    </div>
                </div>
                @if ($product)
                <div class="col">
                    <div class="quickview__info">
                        <form action="#">
                            ...
                            <p class="product__details--info__desc mb-15">{{ Str::limit($product->description, 140) }}</p>
