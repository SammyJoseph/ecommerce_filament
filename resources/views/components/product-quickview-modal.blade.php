{{-- Escuchamos eventos personalizados 'open-quickview' y 'close-quickview' en window --}}
<div x-data="{ show: false, product: null }"
    @open-quickview.window="
    console.log('7. open-quickview event CAUGHT by modal component!', $event.detail);
    show = true;
    product = $event.detail; // Puedes usar product si necesitas datos directamente en Alpine
    "
    @keydown.escape.window="show = false" {{-- Opcional: cerrar con ESC --}}
    x-cloak {{-- Opcional: Oculta hasta que Alpine inicialice --}}
>
    {{-- Usamos x-show para alternar la visibilidad --}}
    {{-- x-transition para animación (opcional, requiere CSS o plugin de Alpine) --}}
    {{-- @click.away para cerrar al hacer clic fuera (si el modal-dialog no ocupa todo) --}}
    <div class="modal" id="modal1" {{-- Mantén el ID si tu JS/CSS lo necesita --}}
         data-animation="slideInUp" {{-- Tu animación CSS/JS existente --}}
         x-show="show"
         ...
         style="display: none;" {{-- Importante para evitar flash inicial antes de Alpine --}}
         >

        <div class="modal-dialog quickview__main--wrapper" @click.away="show = false">
            <header class="modal-header quickview__header">
                 {{-- Usamos @click de Alpine para cerrar --}}
                <button class="close-modal quickview__close--btn" aria-label="close modal" @click="show = false">✕ </button>
            </header>
                ...
                <div class="row row-cols-lg-2 row-cols-md-2">
                    <div class="col">
                        <div class="product__details--media">
                            {{-- Wrapper para la galería principal --}}
                            <div id="quickview-gallery-wrapper" class="product__media--preview swiper">
                                <div class="swiper-wrapper">
                                    {{-- Los slides se generarán con JS --}}
                                </div>
                            </div>
                             {{-- Wrapper para las miniaturas --}}
                            <div id="quickview-thumbnails-wrapper" class="product__media--nav swiper">
                                <div class="swiper-wrapper">
                                    {{-- Las miniaturas se generarán con JS --}}
                                </div>
                    ...
                    <div class="col">
                        <div class="quickview__info">
                            <form action="#">
                                <h2 id="quickview-title" class="product__details--info__title mb-15">Product Title Placeholder</h2>
                                <div id="quickview-price" class="product__details--info__price mb-12">
                                ...
                                <p id="quickview-description" class="product__details--info__desc mb-15">Product description placeholder...</p>
